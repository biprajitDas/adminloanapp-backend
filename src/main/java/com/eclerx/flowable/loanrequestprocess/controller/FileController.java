...
import com.eclerx.flowable.loanrequestprocess.payload.UploadFileResponse;
...
public class FileController {
	 ...
	 private static final Logger logger = LoggerFactory.getLogger(FileController.class);
	    ...
	    public UploadFileResponse uploadFile(@RequestParam("file") MultipartFile file, @RequestHeader("filename") String name) {
